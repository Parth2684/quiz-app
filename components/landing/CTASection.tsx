...
export const CTASection = () => {
    return (
      <section className="relative z-10 px-4 sm:px-6 py-16 sm:py-20">
        <motion.div
          className="max-w-5xl mx-auto text-center bg-linear-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-lg border border-white/10 rounded-3xl p-8 sm:p-12"
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
        >
          <h2 className="text-3xl py-1 sm:py-2 sm:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 bg-linear-to-r from-white to-purple-200 bg-clip-text text-transparent">
